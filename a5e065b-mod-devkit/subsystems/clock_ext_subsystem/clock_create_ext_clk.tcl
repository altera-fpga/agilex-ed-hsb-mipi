...
set_shell_parameter REF_CLK_FREQ      "300"
...
proc derive_parameters {param_array} {
    ...
    set v_drv_ref_clk_freq [get_shell_parameter REF_CLK_FREQ]
...
proc transfer_files {} {
    ...
    set v_design_dir        "${v_script_path}/../.."

    file_copy ${v_design_dir}/non_qpds_ip/intel_iopll_locked_shim           ${v_project_path}/non_qpds_ip/user
    file_copy ${v_design_dir}/non_qpds_ip/intel_issp_reset_shim             ${v_project_path}/non_qpds_ip/user
    file_copy ${v_design_dir}/non_qpds_ip/intel_vip_reset_sync_block        ${v_project_path}/non_qpds_ip/user
    file_copy ${v_design_dir}/non_qpds_ip/intel_vvp_reset_extend            ${v_project_path}/non_qpds_ip/user
    file_copy ${v_design_dir}/non_qpds_ip/clock_ext_subsystem.ipx           ${v_project_path}/non_qpds_ip/user
}
...
proc create_clock_ext_subsystem {} {
    set v_project_path              [get_shell_parameter PROJECT_PATH]
    ...
    add_instance input_rst1_bridge    altera_reset_bridge
    add_instance input_rst2_bridge    altera_reset_bridge
    add_instance input_rst_ctrl       altera_reset_controller

    add_instance input_cpu_bridge     altera_clock_bridge
    ...
    # input_rst1_bridge
    set_instance_parameter_value  input_rst1_bridge  ACTIVE_LOW_RESET            0
    set_instance_parameter_value  input_rst1_bridge  SYNCHRONOUS_EDGES           none
    set_instance_parameter_value  input_rst1_bridge  NUM_RESET_OUTPUTS           1
    set_instance_parameter_value  input_rst1_bridge  USE_RESET_REQUEST           0
    set_instance_parameter_value  input_rst1_bridge  SYNC_RESET                  0

    # input_rst2_bridge
    set_instance_parameter_value  input_rst2_bridge  ACTIVE_LOW_RESET            1
    set_instance_parameter_value  input_rst2_bridge  SYNCHRONOUS_EDGES           none
    set_instance_parameter_value  input_rst2_bridge  NUM_RESET_OUTPUTS           1
    set_instance_parameter_value  input_rst2_bridge  USE_RESET_REQUEST           0
    set_instance_parameter_value  input_rst2_bridge  SYNC_RESET                  0

    # input_rst_ctrl
    set_instance_parameter_value  input_rst_ctrl    NUM_RESET_INPUTS            [expr {2 + ${v_remote_reset_en}} ]
    ...
    # input_rst1_bridge
    add_connection input_rst1_bridge.out_reset  input_rst_ctrl.reset_in0
    add_connection input_rst2_bridge.out_reset  input_rst_ctrl.reset_in1

    # Create Exports
    # input_cpu_bridge
    add_interface          i_clk_cpu        clock       sink
    set_interface_property i_clk_cpu        export_of   input_cpu_bridge.in_clk
    ...
    set_interface_property ia_board_reset   export_of   input_rst1_bridge.in_reset

    add_interface          i_rst_cpu        reset       sink
    set_interface_property i_rst_cpu        export_of   input_rst2_bridge.in_reset
    ...
    if {${v_remote_reset_en}} {
        ...
        # input_rst1_bridge
        add_connection input_rst1_bridge.out_reset     input_jtag_reset.clk_reset
        # input_jtag_reset
    ...
    for {set v_i 0} {${v_i} < ${v_num_gen_clocks}} {incr v_i} {
        ...
        if {${v_pll_output_index} == 0} {
            ...
            set_instance_parameter_value  iopll_${v_pll_index}  gui_enable_permit_cal         1
            ...
            set_interface_property  permit_cal  export_of \
                iopll_${v_pll_index}.permit_cal
    ...
    add_instance output_async_rst_bridge   altera_reset_bridge

    # output_async_rst_bridge
    set_instance_parameter_value  output_async_rst_bridge  ACTIVE_LOW_RESET            0
    set_instance_parameter_value  output_async_rst_bridge  SYNCHRONOUS_EDGES           none
    set_instance_parameter_value  output_async_rst_bridge  NUM_RESET_OUTPUTS           1
    set_instance_parameter_value  output_async_rst_bridge  USE_RESET_REQUEST           0
    set_instance_parameter_value  output_async_rst_bridge  SYNC_RESET                  0

    add_connection  reset_extender.out_reset output_async_rst_bridge.in_reset

    add_interface          a_rst_out   reset      source
    set_interface_property a_rst_out   export_of  output_async_rst_bridge.out_reset
...
proc edit_top_level_qsys {} {
    ...
    add_interface          ${v_instance_name}_a_rst_out          reset       source
    set_interface_property ${v_instance_name}_a_rst_out          export_of   ${v_instance_name}.a_rst_out

    add_interface          ${v_instance_name}_i_rst_cpu          reset       sink
    set_interface_property ${v_instance_name}_i_rst_cpu          export_of   ${v_instance_name}.i_rst_cpu

    add_interface          permit_cal                            reset       sink
    set_interface_property permit_cal                            export_of   ${v_instance_name}.permit_cal
...
proc add_auto_connections {} {
    ...
    add_auto_connection ${v_instance_name} i_ref_clk       refclk_pll
    ...
    add_auto_connection ${v_instance_name} a_rst_out  async_reset
    add_auto_connection ${v_instance_name} i_clk_cpu          ${v_cpu_clk_freq_hz}
...
proc edit_top_v_file {} {
    ...
    add_declaration_list wire "" async_out_reset
    add_qsys_inst_exports_list ${v_instance_name}_a_rst_out_reset    async_out_reset
    add_qsys_inst_exports_list permit_cal_export                     o_pll_lock
    add_qsys_inst_exports_list ${v_instance_name}_i_rst_cpu_reset_n  o_pll_lock
